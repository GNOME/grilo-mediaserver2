...
#ifndef __dbus_glib_marshal_dgrilo_media_container_MARSHAL_H__
#define __dbus_glib_marshal_dgrilo_media_container_MARSHAL_H__
...
void
dbus_glib_marshal_dgrilo_media_container_VOID__STRING_STRING_POINTER (GClosure     *closure,
...
extern void dbus_glib_marshal_dgrilo_media_container_VOID__STRING_POINTER (GClosure     *closure,
                                                                           ...
                                                                           gpointer      marshal_data);
void
dbus_glib_marshal_dgrilo_media_container_VOID__STRING_POINTER (GClosure     *closure,
                                                               GValue       *return_value G_GNUC_UNUSED,
                                                               guint         n_param_values,
                                                               const GValue *param_values,
                                                               gpointer      invocation_hint G_GNUC_UNUSED,
...
#define dbus_glib_marshal_dgrilo_media_container_NONE__STRING_POINTER	dbus_glib_marshal_dgrilo_media_container_VOID__STRING_POINTER

G_END_DECLS

#endif /* __dbus_glib_marshal_dgrilo_media_container_MARSHAL_H__ */

#include <dbus/dbus-glib.h>
static const DBusGMethodInfo dbus_glib_dgrilo_media_container_methods[] = {
  { (GCallback) dgrilo_media_container_get, dbus_glib_marshal_dgrilo_media_container_NONE__STRING_STRING_POINTER, 0 },
  { (GCallback) dgrilo_media_container_get_all, dbus_glib_marshal_dgrilo_media_container_NONE__STRING_POINTER, 80 },
};

const DBusGObjectInfo dbus_glib_dgrilo_media_container_object_info = {
  0,
  dbus_glib_dgrilo_media_container_methods,
  2,
